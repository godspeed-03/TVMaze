...
console.log(status === 'Running')
  ...
  (
    <Loader />
      ...
      <div className=" w-full md:h-[100vh] h-full  bg-cover shadow-2xl bg-no-repeat bg-center  flex flex-col justify-center items-center"
         ...
         <div className="w-full md:h-[100vh] h-full max-md:py-5 bg-white/[0.8] flex items-center justify-center">
           <div className=" max-w-[80rem] flex max-md:flex-col gap-10 mx-auto">
             <div className="left flex-[0.5] flex items-center justify-center">
               <img className=' h-96 rounded-lg shadow-2xl' src={bg??img} alt="" />
             </div>
             <div className="right flex-[0.7] text-black max-md: pl-3">
               ...
               <div className="extra flex max-md:flex-col mt-5 gap-8">
                 <div className="status flex items-center ">
                   <span>Status : </span>
                   <span className={` ${status === 'Running' ? "text-green-700" : status === 'Ended' ? "text-red-700" : ""} text-xl pl-2`}>{status}</span>
